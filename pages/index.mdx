...
[submit here](https://airtable.com/appjllzCGBoIdMFuI/pagirfbPh40T7qK1N/form)

Check out the template code below, which uses the [cat API](https://thecatapi.com/) and python to get a random picture of a cat and adds a custom message based on the time of day. This could be a good starting place or useful if you find yourself stuck — but please don't submit my own code back to me with only a couple of lines changed. I'm looking for something creative or something using an API.
